...
const queueNameDeleteParcel = 'staging.2stage.delete.parcels'
...
// publish side should config queue same as this config
const configRascal = {
    vhosts: {
        ['staging']: {
            ...configHost,
            ...
            queues: {
                ...
                [queueNameDeleteParcel]: {
                    options: {
                        ...
                        arguments: {
                            'x-message-ttl': 50000000000000,
                            'x-dead-letter-exchange': `${exchangeName}.delete.expired`,
                            'x-dead-letter-routing-key': 'staging.request_delete_is_expired',
                        }
                    }
                }
            },
...
console.log(JSON.stringify(configRascal, null, 2))
async function init() {
